...
상호간의 소통의 중요성을 배우고, 협업을 통한 작업을 하였기에 매우 소중한 경험이라 생각합니다. </c> <br>
 
<button id="btn_toggle" type="button" onclick="location.href = 'https://github.com/charmingjae/raspberry'" target='_blank'>보러가기</button> <br>
...
<button id="btn_toggle" type="button" onclick="location.href = 'index.jsp'" target='_blank'>보러가기</button> <br>
